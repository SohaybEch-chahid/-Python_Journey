...
def say_hello1(*peoples):  # n1, n2, n3, n4
...
say_hello1("Osama", "Ahmed", "Sayed", "Mahmoud")
...
def say_hello2(name="Unknown", age="Unknown", country="Unknown"):

    print(f"Hello {name} Your Age is {age} and Your Country Is {country}")


say_hello2("Osama", "36", "Egypt")
say_hello2("Mahmoud", "28", "KSA")
say_hello2("Sameh", "38")
say_hello2("Ramy")
say_hello2()
